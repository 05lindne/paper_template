...
\newcommand{\comments}[1]{ {\colorbox{yellow}{\scriptsize #1 } } } %on
...
\NewDocumentEnvironment{remark}{O{\textbf{Remark:}}} % Define example environment
{\begin{leftrule}\noindent\textcolor{graylight}{#1}\par}
{\end{leftrule}}

%switch comment of passages that need revision on and off.
\newcommand*{\verify}[1]{#1} %off
% \newcommand{\verify}{\todo[color=yellow]{verify}}
...
% \renewcommand{\todo}[1]{#1} %todo off
% \renewcommand{\todo}[1]{\correct{#1}}


% \newcommand*{\fancyrefsubseclabelprefix}{section}
